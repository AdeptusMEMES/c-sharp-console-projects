...
{
    class CompRock : Flying, IBomb
    {
        static int Clk = 0;
        protected ConsoleColor Cl, Cl1, Cl2;
        ...
        public CompRock() : base()
        {
            ConsoleColor Cl = ConsoleColor.Red;
            ConsoleColor Cl1 = ConsoleColor.Red;
        ...
        public new void Ent()
        {
            ...
            {
                T = true;
                Console.WriteLine("Выберите цвет взрыва 1:");
            ...
            {
                T = true;
                Console.WriteLine("Выберите цвет взрыва 2:");
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("1.Красный");
                Console.ForegroundColor = ConsoleColor.Yellow;
                Console.WriteLine("2.Жёлтый");
                ...
                else
                {
                    ...
                    switch (a)
                    {
                        case 1: Cl1 = ConsoleColor.Red; break;
                        case 2: Cl1 = ConsoleColor.Yellow; break;
                        case 3: Cl1 = ConsoleColor.Green; break;
                        case 4: Cl1 = ConsoleColor.Cyan; break;
                        case 5: Cl1 = ConsoleColor.Blue; break;
                        case 6: Cl1 = ConsoleColor.Magenta; break;
                        default: T = false; break;
                    }
                }
                Console.Clear();
            ...
            {
                T = true;
                Console.WriteLine("Выберите цвет взрыва 3:");
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("1.Красный");
                Console.ForegroundColor = ConsoleColor.Yellow;
                Console.WriteLine("2.Жёлтый");
                ...
                else
                {
                    ...
                    switch (a)
                    {
                        case 1: Cl2 = ConsoleColor.Red; break;
                        case 2: Cl2 = ConsoleColor.Yellow; break;
                        case 3: Cl2 = ConsoleColor.Green; break;
                        case 4: Cl2 = ConsoleColor.Cyan; break;
                        case 5: Cl2 = ConsoleColor.Blue; break;
                        case 6: Cl2 = ConsoleColor.Magenta; break;
                        default: T = false; break;
                    }
                }
                Console.Clear();
            ...
            for (int i = 0; i < H; i++)
            {
                for (int j = 0; j < W; j++)
                {
                    if (A[i, j] == '*' || A[i, j] == '^')
                    {
                        switch (Clk)
                        {
                            case 0: Console.ForegroundColor = Cl; break;
                            case 1: Console.ForegroundColor = Cl1; break;
                            case 2: Console.ForegroundColor = Cl2; break;
                            default:; break;
                        }
                    }
                    Console.Write($"{A[i, j]}");
